      ...
      {aiSearchParams ? (
        ...
        <>
          ...
          <div className="px-4 mt-6">
            <button
              onClick={() => setAiSearchParams(undefined)}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-3 py-2 bg-white/20 text-white rounded-lg text-sm font-semibold hover:bg-white/30 transition"
                    >
                      Clear
                    </button>
                    ...
                    >
                      ...
                      <div className="p-4 space-y-4">
                        ...
                        {article.claims && article.claims.length > 0 && (
                          <div className="space-y-2 bg-secondary/30 rounded-xl p-3 border border-accent/10">
                            <div className="flex items-center gap-2 mb-2">
                              <CheckCircle2 className="w-4 h-4 text-accent" />
                              <h4 className="font-semibold text-sm text-foreground">Fact Check</h4>
                            </div>
                            {article.claims.map((claim, idx) => (
                              <div key={idx} className="text-sm space-y-1 pb-2 border-b border-border/50 last:border-0 last:pb-0">
